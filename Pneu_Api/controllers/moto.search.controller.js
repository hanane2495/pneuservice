                ...
                return res.send(err)
                 ...
                 (err, results) =>{
                     ...
                     pneus_sprix.forEach(pneu_sprix => {
                         pneus2.push(
                             //id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque
                             {
   ...
   if(!errors.isEmpty()){
       ...
       pool.connect((err, db, done) => {
          ...
          //type de pneu !== tous position === tous marque === tous charge === tous vitesse === tous
           ...
           const requete7='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and type=$4 order by id_pneu_m'
           ...
           const requete8='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and position=$4 order by id_pneu_m'
          ...
          //type de pneu === tous position === tous marque !== tous charge === tous vitesse === tous
           ...
           const requete9='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and marque=$4 order by id_pneu_m'
          ...
          //type de pneu === tous position === tous marque === tous charge !== tous vitesse === tous
           ...
           const requete10='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and charge=$4 order by id_pneu_m'
          ...
          //type de pneu === tous position === tous marque === tous charge === tous vitesse !== tous
           ...
           const requete11='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and vitesse=$4 order by id_pneu_m'
           ...
           const parametres12 = [req.body.largeur, req.body.hauteur, req.body.diametre, req.body.marque, req.body.charge, req.body.vitesse]
            ...
            const requete16='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 and type=$4 and position=$5 order by id_pneu_m'
           ...
           const requete20='select id_pneu_m, designation_m, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque from pneu_moto where largeur=$1 and hauteur=$2 and diametre=$3 order by id_pneu_m'
    ...
    if(!errors.isEmpty()){
        ...
        pool.connect((err, db, done) => {
            if(err){
               ...
               db.query(`update pneu_dimension set categorie = $1, type = $2, position = $3, marque = $4, collection = $5, largeur = $6, hauteur = $7, diametre = $8, charge = $9, vitesse = $10, designation_m = $11, carburant = $12, adherence = $13, bruit = $14, marge = $15, image_pneu = $16, image_1 = $17, image_2 = $18, image_marque = $19, promo = $20  where pneu_id = $21`,
               [req.body.categorie, req.body.type, req.body.position, req.body.marque, req.body.collection, req.body.largeur, req.body.hauteur, req.body.diametre, req.body.charge, req.body.vitesse, req.body.designation_m, req.body.carburant, req.body.adherence, req.body.bruit, req.body.marge, req.body.image_pneu, req.body.image_1, req.body.image_2, req.body.image_marque, req.body.promo, req.body.id_pneu_m] ,
               (err, results) => {
                   done()
                   if(err){
                    console.log(err)
