...
exports.searchPneusController = (req, res) => {
                     ...
                     pneus_sprix.forEach(pneu_sprix => {
                         pneus2.push(
                             //id_pneu_pl, designation_pl, collection, type, marque, largeur, hauteur, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, image_marque
                             {
                                ...
                                image_marque:pneu_sprix.marque_img
                             }
                         )
                     })
   ...
   if(!errors.isEmpty()){
       ...
       pool.connect((err, db, done) => {
           ...
           const requete2='select id_pneu_pl, designation_pl, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, marque_img from pneu_poids_lourds where largeur=$1 and hauteur=$2 and diametre=$3 and type=$4 order by id_pneu_pl'
           ...
           const requete3='select id_pneu_pl, designation_pl, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, marque_img from pneu_poids_lourds where largeur=$1 and hauteur=$2 and diametre=$3 and position=$4 order by id_pneu_pl'
           ...
           const requete4='select id_pneu_pl, designation_pl, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, marque_img from pneu_poids_lourds where largeur=$1 and hauteur=$2 and diametre=$3 and marque=$4 order by id_pneu_pl'
           ...
           const requete8='select id_pneu_pl, designation_pl, collection, type, marque, largeur, hauteur, diametre, charge, vitesse, position, carburant, adherence, bruit, promo, marge, image_pneu, image_1, image_2, marque_img from pneu_poids_lourds where largeur=$1 and hauteur=$2 and diametre=$3 order by id_pneu_pl'
