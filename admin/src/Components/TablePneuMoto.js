...
const TablePneu = () => {
  ...
  const materialTableRef = useRef(null)
    ...
    function handleDeletePneu (listPneu){
      axios.post(`${process.env.REACT_APP_API_URL}/delete/pneus/moto`, {listPneu})
      .then(res => {
        console.log(res.data.message)
      })
    }

    function handleUpdatePneu(categorie, type, position, marque, collection, largeur, hauteur, diametre, charge, vitesse, designation_m, carburant, adherence, bruit, marge, promo, id_pneu_m){
      axios.post(`${process.env.REACT_APP_API_URL}/update/pneus/moto`, {categorie, type, position, marque, collection, largeur, hauteur, diametre, charge, vitesse, designation_m, carburant, adherence, bruit, marge, promo, id_pneu_m})
      .then(res => {
        console.log(res.data.message)
      })
    }
    function handleAddPneu(categorie, type, position, marque, collection, largeur, hauteur, diametre, charge, vitesse, designation_m, carburant, adherence, bruit, marge, promo ){
      axios.post(`${process.env.REACT_APP_API_URL}/add/pneus/moto`, {categorie, type, position, marque, collection, largeur, hauteur, diametre, charge, vitesse, designation_m, carburant, adherence, bruit, marge, promo})
      .then(res => {
        console.log(res.data.message)
      })
    }
    ...
    useEffect(() => {
      let pneu = []
      axios.post(`${process.env.REACT_APP_API_URL}/get/pneus/moto`)
      .then(res => { 
        pneu = res.data
        setPneus(pneu)
      })
    ...
    useEffect(() => {
        setState({
          columns: [
            ...
            { title: 'Designation', field: 'designation_m'},
          ...
          editable={{
            onRowAdd: (newData) =>
              new Promise((resolve) => {
                setTimeout(() => {
                  resolve();
                  handleAddPneu(newData.categorie, newData.type, newData.position, newData.marque, newData.collection, newData.largeur, newData.hauteur, newData.diametre, newData.charge, newData.vitesse, newData.designation_m, newData.carburant, newData.adherence, newData.bruit, newData.marge, newData.promo)
                  setState((prevState) => {
            ...
            onRowUpdate: (newData, oldData) =>
              new Promise((resolve) => {
                setTimeout(() => {
                  resolve();
                  if (oldData) {
                    handleUpdatePneu(newData.categorie, newData.type, newData.position, newData.marque, newData.collection, newData.largeur, newData.hauteur, newData.diametre, newData.charge, newData.vitesse, newData.designation_m, newData.carburant, newData.adherence, newData.bruit, newData.marge, newData.promo, oldData.id_pneu_m)
                    setState((prevState) => {
                      const data = [...prevState.data];
            ...
            onRowDelete: (oldData) =>
              new Promise((resolve) => {
                setTimeout(() => {
                  resolve();
                  let listPneu = [oldData.id_pneu_m]
